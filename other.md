...
This application was developed out of Fullstack Academy's boilermaker code (https://github.com/FullstackAcademy/boilermaker)

##

Food Desert is a personal project of mine I've been thinking about a while. I figured its a great excuse to familiarize myself with React Hooks and get some practice with the Mapbox API. Grocery store data is collected from the NY Department of Agriculture and Markets (https://data.ny.gov/Economic-Development/Retail-Food-Stores/9a8c-vfzj).
